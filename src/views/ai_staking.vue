  ...
  methods: {
    ...
    fillMax(){
      if(this.userState=='deposit'){
        let tempBalance = this.userBakingData.cakeBalance - 100000/10**18;//  - 100000/10**18 to avoid error
        if (tempBalance < 0) {  
          tempBalance = 0;
        }
        ...
        let tempBalance = this.userBakingData.stakingBalance - 100000/10**18; //  - 100000/10**18 to avoid error
        if (tempBalance < 0) {  
          tempBalance = 0;
        }
        this.$set(this, 'depositBalance', tempBalance);
