        ...
        <div class="menu-left-box">
          ...
          >
            ...
            <el-submenu index="3">
              <template slot="title">
                <i>
                <img class="icon-menu" src="data:image/png;base64,"/>
                </i>
...
export default {
  ...
  mounted() {
    this.isActive = window.innerWidth >= 960?  false : true;
