<template>
  <div class="footer-social">
    <ul class="list-reset">
      <li>
        <a href="https://medium.com/@XBN.Finance" target="_blank">
      ...
      <li>
        <a href="https://xbnfinance.substack.com/" target="_blank" style="border-radius:8px">
          <img :src="require('@/assets/images/substack.png')" style="width:24px; height:24px;"/>
        </a>
      </li>
      <li>
